const navbar = ()=>{
    return `
    rsonal_Development"><p>Personal Development</p><span class="iconify" data-icon="dashicons:arrow-left-alt2" style="font-size: 18px;" data-rotate="180deg"></span></li>
                    <li id="Phy<div id="choti_navbar">
    <div><i class="iconify" data-icon="clarity:menu-line" style="color: #363b42;" data-width="24"></i></div>
    <a href="./"><img src="./components/icons/download.svg" alt=""></a>
    <div><i class="iconify" data-icon="carbon:search" style="color: #373a3c;" data-width="20"></i></div>
</div>
<div id="jnavbar">
    <a href="./index.php"><img class="coursera" src="./components/icons/download.svg" alt=""></a>
    <div id="explore">
        ...
        <div id="explore_option">
            ...
            <div class="left_explore_option">
                <ul>
                    ...
                    <li id="Pesical_Science_and_Engineering"><p>Physical Science and Engineering</p><span class="iconify" data-icon="dashicons:arrow-left-alt2" style="font-size: 18px;" data-rotate="180deg"></span></li>
